  ...
  return (
    ...
    >
      <div className="mt-12 lg:mt-20">
        ...
        <h2 className="hero-subheading bg-linear-to-b from-pink-100 to-purple-300 bg-clip-text text-center text-2xl tracking-tighter text-transparent">
          {PROFILE.role}
        </h2>
      </div>
      ...
      <a
        href="/Basharat-Ashraf-Resume.pdf"
        target="_blank"
